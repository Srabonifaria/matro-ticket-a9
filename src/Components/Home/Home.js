            ...
            <div className="row">
                <div className="col-md-3 my-3">
                    <div className="ticket-div-1 background">
                        ...
                        <button onClick={() => handleBookingTicket("one-time-ticket")} className="btn my-5 btn-primary py-3 px-5 fs-5">BUY NOW</button>
                        <h1>$100</h1>
                    </div>
                </div>
                <div className="col-md-3 my-3">
                    <div className="ticket-div-2 background">
                        <h1>one day pass</h1>
                        <button  onClick={() => handleBookingTicket("one-day-pass")} className="btn my-5 btn-danger py-3 px-5 fs-5">BUY NOW</button>
                        <h1>$500</h1>
                    </div>
                </div>
                <div className="col-md-3 my-3">
                    <div className="ticket-div-3 background">
                        <h1>monthly pass</h1>
                        <button  onClick={() => handleBookingTicket("monthly-pass")} className="btn my-5 btn-dark py-3 px-5 fs-5">BUY NOW</button>
                        <h1>$1500</h1>
                    </div>
                </div>
                <div className="col-md-3 my-3">
